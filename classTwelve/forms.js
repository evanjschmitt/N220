function validateForm() {
  ...
  //   if ((nameVal == "")) {
  //     document.getElementById("nameError").innerText = "A name is required";
  //   } else {
  //     document.getElementById("nameError").innerText = "";
  //   }
  //   if ((addressVal == "")) {
  //     document.getElementById("addressError").innerText = "A address is required";
  //   } else {
  //     document.getElementById("addressError").innerText = "";
  //   }
  //   if ((cityVal == "")) {
  //     document.getElementById("cityError").innerText = "A city is required";
  //   } else {
